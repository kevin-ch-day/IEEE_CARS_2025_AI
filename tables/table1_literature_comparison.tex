...
Karyotakis et al. \cite{karyotakis2026messaging} & Yes & Yes & Security/privacy & Scenario/build context & 3 messaging apps & Messaging-only \\
...
This study & Yes & Yes & Metadata + tracker context & Exact selected build & 15 heterogeneous apps & Single device; scenario-bounded \\
\bottomrule
\end{tabularx}
\end{table*}
