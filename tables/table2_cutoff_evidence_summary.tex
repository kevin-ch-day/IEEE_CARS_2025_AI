...
\begin{tabular}{@{}p{0.25\columnwidth}p{0.25\columnwidth}p{0.28\columnwidth}c@{}}
\toprule
...
X (Twitter) & Social Media & 12.5.0-release.0 & 3/1/4 \\
...
\end{tabular}
\vspace{1pt}
\begin{flushleft}\tiny Categories reflect primary app function; I/Q/Int reports strict-idle/QFG/interactive runs.\end{flushleft}
\end{table}
