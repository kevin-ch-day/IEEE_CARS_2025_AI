...
\emph{Risk} denotes evidence-supported opportunity for privacy or security harm, not a calibrated probability of exploitation. Static indicators characterize potential exposure; runtime indicators characterize observed behavior. The two layers are interpreted jointly as \emph{risk posture} and are not collapsed into a single score.
