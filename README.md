...
This repository contains the IEEE conference-paper draft for Paper 3 in the ScytaleDroid Android privacy/security research line. The paper is intended for [IEEE CARS 2026](https://www.ieee-cars.org/) and focuses on an empirical 15-app Android consumer-app study using static and runtime evidence.
...
- `sections/` — paper body split into modular files:
  ...
  - `06_discussion.tex`
  - `07_conclusion.tex`
  - references are generated from `references/references.bib`
...
- [ ] Claims preserve the cutoff evidence boundaries: no `15/15 current-build complete`, no `105/105 quota complete`, no QFG-as-strict-idle wording, and no prior-build-as-current-build wording.
